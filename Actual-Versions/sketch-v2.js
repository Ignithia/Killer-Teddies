...
function generatePlatforms(PlatformAmount) {
  ...
  let minPlatformHeight = canvasHeight / 4;
  let maxPlatformHeight = canvasHeight / 1.2;

  for (let i = 0; i < PlatformAmount; i++) {
    let platformWidth = random(minPlatformWidth, maxPlatformWidth);
    let platformX = random(platformWidth / 2, canvasWidth - platformWidth / 2);
    let platformY = random(minPlatformHeight, maxPlatformHeight);
